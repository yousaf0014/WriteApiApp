...
export class ArticleDropdown extends Component {
    render() {
        return (
            <DropdownButton className="dropdown-position"
                                    alignRight
                                    title=""
                                    id="dropdown-menu-align-right"
                                    >
                                    <Dropdown.Item eventKey="1">
                                    <svg width="20px" height="20px" viewBox="0 0 16 16" className="bi bi-pencil mr-2" fill="#a183f7" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <Dropdown.Item eventKey="2">
                                        <svg width="20px" height="20px" viewBox="0 0 16 16" className="bi bi-trash mr-2" fill="#fb5660" xmlns="http://www.w3.org/2000/svg">
